...
class final(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("ENGN 1580 Final Project")
        ...
        self.carrier_freq = carrier_freq = 440
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Passband frequency domain', #name
            1,
            None # parent
        )
        ...
        self.audio_sink_0 = audio.sink(samp_rate, 'pipewire', False)
        ...
        self.connect((self.blocks_int_to_float_0, 0), (self.blocks_multiply_xx_0, 1))
