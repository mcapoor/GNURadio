...
# Title: ENGN 1580 Final Project Transmitter
# Author: Milan Capoor
...
class qpsk_transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "ENGN 1580 Final Project Transmitter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ENGN 1580 Final Project Transmitter")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_transmitter")
    ...
    def get_filter_roll_off(self):
        return self.filter_roll_off
